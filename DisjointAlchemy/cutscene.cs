...
public class CutscenePatcher
{
	...
	static private void method_684(class_264 field2038)
	{
		...
		if (field2038.field_2090 == "outro-5" || field2038.field_2090 == "Disjoint-cutscene-hubris")
	...
	private static void class_252_Method_50(On.class_252.orig_method_50 orig, class_252 class252_self, float timeDelta)
	{
		...
		if (vanillaCutscenes.Contains(cutsceneID) || !DisjointAlchemy.AdvancedContent.Cutscenes.Any(x => x.ID == cutsceneID))
		{
		...
		foreach (var cutscene in DisjointAlchemy.AdvancedContent.Cutscenes.Where(x => x.ID == cutsceneID))
		{
