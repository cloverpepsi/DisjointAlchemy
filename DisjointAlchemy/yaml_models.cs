...
public abstract class ModelWithResourcesDisjoint
{
...
public class AdvancedContentModelDisjoint
{
	...
	public List<CharacterModelDisjoint> Characters;
	public List<CutsceneModelDisjoint> Cutscenes;
	public List<DocumentModelDisjoint> Documents;
	public List<PuzzleModelDisjoint> Puzzles;
...
public class CharacterModelDisjoint : ModelWithResourcesDisjoint
{
	...
	public class_230 FromModel()
	{
		...
		return new class_230(
			...
			ModelHelpersDisjoint.HexColor(this.Color),
			this.IsOnLeft
		);
	}
}
...
/////////////////////////////////////////////////////////////////////////////////////////////////
public class CutsceneModelDisjoint : ModelWithResourcesDisjoint
{
...
//////////////////////////////////////////////////
public class DocumentModelDisjoint : ModelWithResourcesDisjoint
{
	public string ID, Texture;
	public List<DrawItemModelDisjoint> DrawItems;
	...
	public class DrawItemModelDisjoint
	{
		...
		public Document.DrawItem FromModel()
		{
			...
			Color color = isImageItem ? ModelHelpersDisjoint.ColorWhite : DocumentScreen.field_2410;
			if (!string.IsNullOrEmpty(this.Color)) color = ModelHelpersDisjoint.HexColor(int.Parse(this.Color));
			Vector2 position = ModelHelpersDisjoint.Vector2FromString(this.Position);
			...
			if (isImageItem)
			{
				return new Document.DrawItem(
					...
					color,
					ModelHelpersDisjoint.FloatFromString(this.Scale, 1f),
					ModelHelpersDisjoint.FloatFromString(this.Rotation),
					ModelHelpersDisjoint.FloatFromString(this.Alpha, 1f)
				);
			}
			else // isTextItem
			{
				return new Document.DrawItem(
					...
					ModelHelpersDisjoint.FloatFromString(this.LineSpacing, 1f),
					ModelHelpersDisjoint.FloatFromString(this.ColumnWidth, float.MaxValue),
					this.Handwritten
				);
			}
		}
...
public class PuzzleModelDisjoint : ModelWithResourcesDisjoint
{
	public string ID, Music;
	public TipModelDisjoint Tip = null;
	public CabinetModelDisjoint Cabinet;
	...
	public Dictionary<int, Vector2> getJournalPreview()
	{
		...
		if (this.JournalPreview != null)
		{
			...
			{
				ret.Add(kvp.Key, ModelHelpersDisjoint.Vector2FromString(kvp.Value));
			}
		}
		return ret;
	}
...
#pragma warning disable CS0649
	...
	public class CabinetModelDisjoint
	{
		public List<OverlayModelDisjoint> Overlays;
		...
		public class OverlayModelDisjoint
		{
#pragma warning disable CS0649
			public string Texture, Position;
			public Tuple<Texture, Vector2> FromModel()
			{
				return Tuple.Create(fetchTexture(this.Texture), ModelHelpersDisjoint.Vector2FromString(this.Position));
			}
		}
	}
}